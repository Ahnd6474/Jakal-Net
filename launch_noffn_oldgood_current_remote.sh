...
nohup env \
  ...
  --epochs 1.0 \
  --run-name wiki2m-nomemory-b384-r256-h4-softsign-prebuild8x2-span1-1epoch-eval500-adamwfused-lr50e4-warmup500-hold4k-floor1e4-currentcode-20260502 \
  > artifacts/launch_logs/wiki2m-nomemory-b384-r256-h4-softsign-prebuild8x2-span1-1epoch-eval500-adamwfused-lr50e4-warmup500-hold4k-floor1e4-currentcode-20260502.log 2>&1 < /dev/null &
echo pid=$!
echo log=artifacts/launch_logs/wiki2m-nomemory-b384-r256-h4-softsign-prebuild8x2-span1-1epoch-eval500-adamwfused-lr50e4-warmup500-hold4k-floor1e4-currentcode-20260502.log

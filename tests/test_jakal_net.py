...
class JakalNetModuleTests(unittest.TestCase):
    ...
    def test_state_weighted_propagation_uses_state_messages_for_delta_state(self) -> None:
        layer = Layer(
            dim=2,
            num_nodes=3,
        ...
        expected_state = torch.einsum("...ij,...j->...i", weighted_edges, _state_proj_fn(layer.state))

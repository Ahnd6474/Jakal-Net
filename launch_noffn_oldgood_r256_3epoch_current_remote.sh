...
nohup env \
  ...
  --epochs 3.0 \
  --run-name wiki2m-nomemory-b384-r256-h4-softsign-prebuild8x2-span1-3epoch-eval500-adamwfused-lr50e4-warmup500-decay4k-24k-floor50e6-currentcode-20260503 \
  > artifacts/launch_logs/wiki2m-nomemory-b384-r256-h4-softsign-prebuild8x2-span1-3epoch-eval500-adamwfused-lr50e4-warmup500-decay4k-24k-floor50e6-currentcode-20260503.log 2>&1 < /dev/null &
echo pid=$!
echo log=artifacts/launch_logs/wiki2m-nomemory-b384-r256-h4-softsign-prebuild8x2-span1-3epoch-eval500-adamwfused-lr50e4-warmup500-decay4k-24k-floor50e6-currentcode-20260503.log

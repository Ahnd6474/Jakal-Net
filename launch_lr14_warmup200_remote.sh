...
RUN_NAME="wiki2m-nomemory-b384-r256-h4-softsign-prebuild8x2-span1-1epoch-eval500-lr14e4-warmup200-20260430"
LOG_PATH="artifacts/launch_logs/${RUN_NAME}.log"

pkill -f "wiki2m-nomemory-b384-r256-h4-softsign-prebuild8x2-span1-1epoch-eval500-warmup500-20260430" || true

nohup /venv/main/bin/python scripts/train_causal_memory_lm.py \
  --device cuda \
  --precision bf16 \
